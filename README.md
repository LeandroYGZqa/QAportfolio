...
- Pruebas exploratorias en licitaciones y publicidad  
- Pasos de prueba documentados para procesos B2B  
- Smoke tests en staging para garantizar estabilidad  
- Bugs críticos reportados en Jira  
- Mejora de procesos en SCRUM, reduciendo cuellos de botella en 10%

**Trainee QA** *(Feb 2021 – Dic 2021)*  
- Pruebas exploratorias supervisadas  
- Bugs documentados con claridad  
- Casos de prueba para funciones básicas  
